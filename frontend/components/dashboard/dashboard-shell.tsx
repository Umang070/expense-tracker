...
<div className="grid h-full w-full bg-white md:grid-cols-[280px_1fr]">
  <aside className="h-screen overflow-y-auto border-b border-slate-200 bg-white p-6 md:border-b-0 md:border-r">
    <Link href="/dashboard" className="block">
      <Image
        src="/logo.png"
        alt="Expense Tracker"
  ...
  <section className="overflow-y-auto min-h-0 p-6 sm:p-8">
    <h2 className="text-2xl font-semibold text-slate-900">{title}</h2>
    <p className="mt-2 text-sm text-slate-600">{description}</p>
    <div className="mt-6">{children}</div>
  </section>
